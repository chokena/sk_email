...
<html lang="en">
 ...
 $id_user = $_GET['id_user'];
  ...
  function showData($data_g){
		  ...
		  $id_user = $_GET['id_user'];
		   include("connect.php");
       $sql =  "SELECT * FROM  `tb_msg_show`  WHERE  `id_user` ='$id_user' and data_group = '$data_g'  and msg_group ='OUTPUT'"; 
   			$i=0;
   ...
   <div class="row" >
    ...
    <div class="row" >
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="active"><a href="monitor_output.php?id_user=<? echo $id_user; ?>">OUTPUT</a></li>
        <li role="presentation"><a href="monitor_alarm.php?id_user=<? echo $id_user; ?>">ALARM</a></li>
