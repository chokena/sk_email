...
var options = {
	...
	},
	{
		...
		dataPoints: [
			...
			{ x: new Date(2017, 10, 2), y: 5 },
			{ x: new Date(2017, 10, 3), y: 5 },
			{ x: new Date(2017, 10, 4), y: 5 },
			{ x: new Date(2017, 10, 5), y: 5 },
			{ x: new Date(2017, 10, 6), y: 5 },
			{ x: new Date(2017, 10, 7), y: 5 },
			{ x: new Date(2017, 10, 8), y: 6 },
			{ x: new Date(2017, 10, 9), y: 6 },
			{ x: new Date(2017, 10, 10), y: 6 },
			{ x: new Date(2017, 10, 11), y: 3 },
			{ x: new Date(2017, 10, 12), y: 7 },
			{ x: new Date(2017, 10, 13), y: 6 },
			{ x: new Date(2017, 10, 14), y: 6 },
			{ x: new Date(2017, 10, 15), y: 4 }
		]
	}]
};
