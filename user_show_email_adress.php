...
if ($result->num_rows > 0) {
  ...
  <tr>
    <td width="21%"> <center> <font color="#0000FF" > ID PATH  </font></center></td>
    <td width="29%"> <center> <font color="#333333"> username </font></center></td>
    <td width="26%"><center><font color="#FF0000">  password </font></center></td>
    <td width="24%"><center>
     แก้ไข <br />
     email ที่ส่ง
    </center></td>
    ...
    <td> <center><a href="edit_email_adress_form.php?id_user=<? echo  $row['id_user'];?>"> <img src="images/edit.png" width="41" height="41" /> </a></center></td>
  </tr>
    <?
	}
	?>
