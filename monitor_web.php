...
<html lang="en">
 ...
 $id_user = $_GET['id_user'];
  ...
  function showData($data_g){
          ...
          //echo $data_type;
		   include("connect.php");
       $sql =  "SELECT * FROM  `tb_msg_show`  WHERE  `id_user` ='$id_user' and data_group = '$data_g'  and msg_group ='$data_type'"; 
   			$i=0;
    ...
    $sql =  "SELECT * FROM  `tb_led_show`  WHERE  `id_user` ='$id_user' and data_group = '$data_g'  and msg_group ='$data_type'"; 
   			$i=0;
    	$result = $conn->query($sql); 
   		if ($result->num_rows > 0) {	  
	  $row = $result->fetch_assoc();
        ...
        <td>
          <table width="100%" border="1">
           <tr>
            ...
            <?php 
             if($_GET['type']=="INPUT") $cr = "#4E9880";
             //if($_GET['type']=="OUTPUT")
            ?>
            <tr>
              <td width="25%" bgcolor="<?php if($_GET['type']=="INPUT")
               echo $cr = "#4E9880"; else echo "#ffffff" ?>" >
                <center>  <font size="+2"  color="<?php if($_GET['type']=="INPUT")
               echo "#ffffff"; else echo "#000000" ?>">  INPUT </font><br>
              <a href="monitor_web.php?id_user=<? echo $id_user; ?>&type=INPUT "> <img src="images/list.png" width="30" /> </a>
              
              </center>
              <br/>
              </td>
              <td width="25%" bgcolor="<?php if($_GET['type']=="OUTPUT")
               echo $cr = "#4E9880"; else echo "#ffffff" ?>" >
              <center>  <font size="+2" color="<?php if($_GET['type']=="OUTPUT")
               echo "#ffffff"; else echo "#000000" ?>" >  OUTPUT </font><br>
               <a href="monitor_web.php?id_user=<? echo $id_user; ?>&type=OUTPUT "> <img src="images/list.png" width="30" /> </a>
                
              </center>
              <br/>
              </td>
              <td  colspan="2" width="50%" bgcolor="<?php if($_GET['type']=="ALARM")
               echo $cr = "#4E9880"; else echo "#fffff" ?>" >
                <center>  <font size="+2" color="<?php if($_GET['type']=="ALARM")
               echo "#ffffff"; else echo "#000000" ?>"   > ANALOG/ALARM  </font><br>
               <a href="monitor_web.php?id_user=<? echo $id_user; ?>&type=ALARM "> <img src="images/list.png" width="30" /> </a>
