...
if ($result->num_rows > 0) {
  ...
  <tr>
    ...
    <td> <center><a href="delete_data.php?id_user=<? echo  $row['id_user'];?>" onclick="return confirm('Are you sure you want to delete?');" > <img src="images/Delete.png" width="41" height="41" /> </a></center></td>
  </tr>
    <?
	}
	?>
